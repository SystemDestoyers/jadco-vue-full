...
- Fixed CSS specificity issue in admin theme that was affecting frontend navigation links
- Fixed about section logo positioning by restoring the about-heading container wrapper
